                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                        <div className='w-full flex flex-col items-center rounded-lg bg-[#1b1c23]'>
                            <div className='flex justify-start items-center w-full p-2 rounded-t-lg'>
                                <div className='text-gray-400 text-2xl p-2'>Skills</div>
                            </div>
                            <div className='flex w-full p-2 h-auto text-sm bg-[#1b1c23] rounded-b-lg gap-2 flex-wrap'>
                                <div className='bg-[#14131a] p-1 rounded-md text-gray-300 border border-orange-300'>C/C++</div>
                                <div className='bg-[#14131a] p-1 rounded-md text-gray-300 border border-green-300'>Python</div>
                                <div className='bg-[#14131a] p-1 rounded-md text-gray-300 border border-red-300'>Java</div>
                                <div className='bg-[#14131a] p-1 rounded-md text-gray-300 border border-blue-300'>DSA</div>
                                <div className='bg-[#14131a] p-1 rounded-md text-gray-300 border border-pink-300'>Software Engineering</div>
                            </div>
                        </div>
                        <div className='w-full flex flex-col items-center rounded-lg bg-[#1b1c23]'>
                            <div className='flex justify-start items-center w-full p-2 rounded-t-lg'>
                ...
                <div className='py-5'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
                        {project_data.map((project) => {
                            return (
                                <div key={project.id} onClick={() => { setToggle(!toggle); setProjectId(project.id) }} className='w-full relative flex flex-col items-center hover:scale-105 rounded-lg duration-500'>
                                    <div className='absolute right-1 top-1 text-gray-400'><FaAngleDown size={20} /></div>
